...
import { Lock, Mail, Loader2, AlertCircle, Eye, EyeOff } from "lucide-react"; // 1. استيراد أيقونات العين
...
export default function LoginPage() {
  ...
  // 2. حالة جديدة للتحكم في ظهور كلمة المرور
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
                {/* أيقونة القفل (ثابتة يمين) */}
                <Lock className="absolute right-4 top-3.5 text-slate-400" size={20}/>
                
                <input 
                    // 3. تغيير نوع الحقل بناءً على الحالة
                    type={showPassword ? "text" : "password"} 
                    required 
                    // زودنا pl-12 عشان الكلام مايدخلش تحت زرار العين
                ...
                {/* 4. زرار التبديل (يسار) */}
                <button
                    type="button" // مهم جداً عشان مايعملش submit للفورم
          ...
          <button disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-bold text-lg shadow-lg flex justify-center items-center gap-2">
